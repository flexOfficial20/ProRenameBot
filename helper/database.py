...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @ANIME_BARLOW" -metadata author="@FLEXdub_Official" -metadata:s:s title="Subtitled By :- @ANIME_BARLOW" -metadata:s:a title="By :- @ANIME_BARLOW" -metadata:s:v title="By:- @FLEXdub_Official" """
        )
